...
public class Pool {
    ...
    public static void main(String[] args) {
        Pool pool = new Pool("com.mysql.jdbc.Driver",
                "jdbc:mysql://127.0.0.1:3306/springMvc?useUnicode=true&amp;characterEncoding=utf-8&amp;autoReconnect=true",
                "root", "nothing");
        try {
            pool.createConnections(POOL_SIZE);
